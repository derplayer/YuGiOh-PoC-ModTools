...
namespace CustomControls
{
    partial class MyOpenFileDialogControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.FileDlgCaption = "Select an Image (*.yga)";
            ...
            this.FileDlgFilter = "Yu-Gi-Oh Graphics Acronym (*.yga)|*.yga";//|Yu-Gi-Oh All Image Files (*.bmp, *.png, *.yga)|*.bmp;*.png;*.yga";
            this.FileDlgFilterIndex = 1;
            this.FileDlgOkCaption = "Convert";
